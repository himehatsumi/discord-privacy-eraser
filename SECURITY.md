...
- Removal of the complete pre-deletion scan, target lock, or in-panel exact typed confirmation. Combining the scan and deletion loop behind one button must not bypass those gates.

...
Preferences and recovery checkpoints are stored using the userscript manager's private value storage. If that API is unavailable, the script falls back to Discord-origin `localStorage`.
